...
public class SceneController : MonoBehaviour
{
    ...
    public string startingSceneName = "Floor22";
    public string initialStartingPositionName = "MyDesk";
    ...
    private IEnumerator FadeAndSwitchScenes(string sceneName)
    {
        ...
        // 找到当前 active 的 Scene 并异步 unload
...
//    public string initialStartingPositionName = "FaceToBoss";
